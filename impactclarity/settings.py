"""
Django settings for impactclarity project.
"""
import os
...
ROOT_URLCONF = 'impactclarity.urls'
...
WSGI_APPLICATION = 'impactclarity.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'impactclarity'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'impactclarity@net.com'
else:
